...
public class testMID_high_cone_pickup_cube_level extends SequentialCommandGroup {

    public testMID_high_cone_pickup_cube_level (robotDrive _robotDrive, scoring _score,  LimeLight _limelight, intake _intake)  {
        ...
        addCommands(
          ...
          //   new delay(0.01),
            ...
            new autoDriveSlowPos(_robotDrive, -34000*ratio),
