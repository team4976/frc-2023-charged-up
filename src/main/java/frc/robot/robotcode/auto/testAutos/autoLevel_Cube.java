...
public class autoLevel_Cube extends SequentialCommandGroup {

    public autoLevel_Cube (robotDrive _robotDrive, scoring _score,  LimeLight _limelight, hand_off _hand_off, intake _intake)   {
